...
export function TablePlanoContas<TData, TValue>({
  columns,
  data,
  rowCount
}: DataTableProps<TData, TValue>) {

  const [sorting, setSorting] = useStoreTablePlanoContas(state => [state.sorting, state.setSorting])
  const [pagination, setPagination] = useStoreTablePlanoContas(state => [state.pagination, state.setPagination])
