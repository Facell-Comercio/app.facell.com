...
export const useFormDepositoData = (
...
const schemaOcorrencia = z.object({
  ...
  id_user_resolvedor: z.coerce
    .string()
    .optional(),
  id_filial: z.coerce.string().optional(),
  data_ocorrencia: z.coerce
    .string()
    .trim()
    .min(1, "Campo obrigatório"),
  data_caixa: z.coerce
...
export const useFormOcorrenciaData = (
