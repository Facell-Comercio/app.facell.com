...
export const BlocoRecorrenciasPendentes = () => {
    return (
        <Card className="">
      <CardHeader>
        <CardTitle className="text-xl flex items-center justify-between">
            <span>Recorrências Pendentes</span> <Badge variant={'destructive'} className="text-base">1</Badge>
        </CardTitle>
      </CardHeader>
      <CardContent>
      <div className="overflow-auto scroll-thin pb-3">
                    ...
                    <table className="text-sm">
                        ...
                        <tbody>
                            <tr className="text-nowrap">
                                <td className="p-2 text-primary font-semibold cursor-pointer"><File/></td>
