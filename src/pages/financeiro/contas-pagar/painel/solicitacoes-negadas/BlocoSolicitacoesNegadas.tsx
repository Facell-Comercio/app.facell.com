...
export const BlocoSolicitacoesNegadas = () => {
  return (
    <Card className="">
      <CardHeader>
        <CardTitle className="text-xl flex items-center justify-between">
          <span>Solicitações Negadas</span> <Badge variant={'destructive'} className="text-base">3</Badge>
        </CardTitle>
      </CardHeader>
      <CardContent>
        <div className="overflow-auto scroll-thin pb-3">
          ...
          <table className="text-sm">
            ...
            <tbody>
              <tr className="text-nowrap">
                <td className="p-2 text-primary font-semibold cursor-pointer">10652</td>
