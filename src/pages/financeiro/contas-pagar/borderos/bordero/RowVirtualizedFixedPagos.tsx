...
const RowVirtualizerFixedPagos: React.FC<
  RowVirtualizerFixedPagosProps
> = ({ data, filteredData, modalEditing }) => {
  const { mutate: reverseManualPayment } =
    useBordero().reverseManualPayment();
  const authorized = checkUserDepartments(
    "FINANCEIRO",
    true
  );
