...
type ChartConciliacaoRecebimentosProps = {
  data: DataChart[];
  isLoading: boolean;
};

const ChartConciliacaoRecebimentos = ({ data, isLoading }: ChartConciliacaoRecebimentosProps) => {
  if (isLoading) {
    return (
  ...
  const chartData = mergeDataWithDays({
    days: daysArray,
    data,
    defaultProps: { "Conciliado": 0, "Pendente": 0 },
  });
...
export default ChartConciliacaoRecebimentos;
