...
import { useStoreTableConciliacaoCP } from "./store-table";
          ...
          <ScrollArea className="w-fill whitespace-nowrap rounded-md pb-4">
            <div className="flex w-max space-x-4">
              ...
              <Input
                ...
                className="max-w-[200px]"
                value={filters.id_transacao}
                onChange={(e) => {
                  setFilters({ id_transacao: e.target.value });
                }}
              />
              <Input
                ...
                onChange={(e) => {
                  setFilters({ documento: e.target.value });
                }}
              />
              <Select
                value={filters.conciliado}
                onValueChange={(conciliado) => {
                  setFilters({ conciliado: conciliado });
                }}
              >
                ...
                <SelectContent>
                  <SelectItem value="0">Não Conciliado</SelectItem>
                  <SelectItem value="1">Conciliado</SelectItem>
                </SelectContent>
              </Select>
            </div>
