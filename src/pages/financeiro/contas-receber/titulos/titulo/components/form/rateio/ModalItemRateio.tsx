...
import z from "zod";
import { TituloCRSchemaProps, rateioSchema } from "../../../form-data";
        ...
        <Form {...formItemRateio}>
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>Preencha todos os campos para prosseguir</DialogDescription>
            </DialogHeader>
