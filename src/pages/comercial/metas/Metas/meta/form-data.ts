...
const schemaMeta = z.object({
  ...
  controle: z.coerce.string({ required_error: "Campo obrigatório" }),
  pos: z.coerce.string({ required_error: "Campo obrigatório" }),
  ...
  wttx: z.coerce.string({ required_error: "Campo obrigatório" }),
  live: z.coerce.string({ required_error: "Campo obrigatório" }),
});
// .refine(
//   (data) =>
...
// )
export const useFormMetaData = (data: MetasProps) => {
  const form = useForm<MetasProps>({
