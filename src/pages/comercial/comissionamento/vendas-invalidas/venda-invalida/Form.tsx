...
import { useFormVendasInvalidaData } from "./form-data";
...
const FormVendasInvalida = ({
  ...
  } = useVendasInvalidas().insertOne();
  const {
    mutate: update,
    isPending: updateIsPending,
    isSuccess: updateIsSuccess,
    isError: updateIsError,
  } = useVendasInvalidas().update();
  ...
  const { form } =
    useFormVendasInvalidaData(data);
...
export default FormVendasInvalida;
