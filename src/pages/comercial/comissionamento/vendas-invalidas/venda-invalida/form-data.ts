import { VendasInvalidasProps } from "@/hooks/comercial/useVendasInvalidas";
import { zodResolver } from "@hookform/resolvers/zod";
import { useForm } from "react-hook-form";
import { z } from "zod";

const schemaVendasInvalida = z.object({
  // Dados VendasInvalida
...
// )
export const useFormVendasInvalidaData = (
  data: VendasInvalidasProps
) => {
  const form = useForm<VendasInvalidasProps>({
    resolver: zodResolver(schemaVendasInvalida),
    defaultValues: data,
    values: data,
  });
