import { EspelhosProps } from "@/hooks/comercial/useEspelhos";
import { zodResolver } from "@hookform/resolvers/zod";
import { useForm } from "react-hook-form";
import { z } from "zod";

const schemaEspelho = z.object({
  // Dados Espelho
...
// )
export const useFormEspelhoData = (
  data: EspelhosProps
) => {
  const form = useForm<EspelhosProps>({
    resolver: zodResolver(schemaEspelho),
    defaultValues: data,
    values: data,
  });
