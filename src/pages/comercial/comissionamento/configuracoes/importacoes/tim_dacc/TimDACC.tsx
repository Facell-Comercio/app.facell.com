...
const hrefPlanilhaPadrao =
  "https://docs.google.com/spreadsheets/d/1OU6GSVpgXM2P4Q1zFwNo0cw4xTDpB8Tu/export?format=xlsx";
  ...
  const handleSubmit = async () => {
    try {
      ...
      const data = await api
        .postForm("/comercial/comissionamento/configuracoes/import/tim-dacc", form)
        ...
        action: (
          <ToastAction
            ...
            onClick={() =>
              exportToExcel(
                data,
                `RESULTADO IMPORTAÇÃO TIM DACC ${formatDate(new Date(), "dd-MM-yyyy hh.mm")}`
              )
            }
          >
            Ver Resultados
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      <ModalLogsMovimentoArquivos
        ...
        relatorios={["IMPORT_TIM_DACC"]}
      />
    </section>
  );
};

export default TimDACC;
