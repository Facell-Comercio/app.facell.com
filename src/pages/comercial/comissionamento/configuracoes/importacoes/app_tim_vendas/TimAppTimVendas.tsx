  ...
  const handleSubmit = async () => {
    try {
      ...
      const data = await api
        .postForm("/comercial/comissionamento/configuracoes/import/tim-app-vendas", form)
  ...
  return (
    <section className="flex flex-col gap-3">
      ...
      <ModalLogsMovimentoArquivos
        ...
        relatorios={["IMPORT_TIM_APP_TIM_VENDAS"]}
      />
    </section>
  );
};

export default TimAppTimVendas;
