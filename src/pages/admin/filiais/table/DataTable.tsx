...
function DataTable<TData, TValue>({
  ...
  const [sorting, setSorting] = useStoreFiliais(state => [state.sorting, state.setSorting])
  const [pagination, setPagination] = useStoreFiliais(state => [state.pagination, state.setPagination])
