...
function DataTable<TData, TValue>({
  ...
  const [sorting, setSorting] = useStoreDepartamentos(state => [state.sorting, state.setSorting])
  const [pagination, setPagination] = useStoreDepartamentos(state => [state.pagination, state.setPagination])
